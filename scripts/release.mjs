...
function main(command) {
  ...
  if (command === 'check') {
    ...
    for (const file of ['dist/index.js', 'dist/index.d.ts', 'dist/imports.js', 'dist/runtime.js', 'dist/runtime.d.ts', 'dist/client.js', 'dist/client.d.ts', 'dist/remote.d.ts', 'dist/pool-query.js', 'LICENSE']) {
